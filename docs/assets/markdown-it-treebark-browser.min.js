...
`)&&n?n.repeat(r||0):"";if(e==="$comment")return`<!--${f}${u}-->`;const d=`<${e}${X(t,o,e,a,c,s)}>`;return S.has(e)?d:`${d}${f}${u}</${e}>`}function y(e,t,o){const i=o.parents||[],c=o.logger,n=o.getOuterProperty;if(typeof e=="string")return k(e,t,!0,i,c,n);if(Array.isArray(e))return e.map(l=>y(l,t,o)).join(o.indentStr?`
