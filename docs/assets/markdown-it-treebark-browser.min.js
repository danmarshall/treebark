...
`:"");const i=M(e,o);if(!i)return"";const{tag:r,rest:a,children:l,attrs:u}=i;if(!P.has(r))return o.error(`Tag "${r}" is not allowed`),"";if(r==="$comment"&&t.insideComment)return o.error("Nested comments are not allowed"),"";if(r==="$if"){const{valueToRender:c}=B(a,n,s,o);return c===void 0?"":$(c,n,t)}b.has(r)&&l.length>0&&o.warn(`Tag "${r}" is a void element and cannot have children`);const f={...t,insideComment:r==="$comment"||t.insideComment,level:(t.level||0)+1},v=c=>c===""?[]:t.indentStr&&c.includes(`
`)&&!c.includes("<")?c.split(`
