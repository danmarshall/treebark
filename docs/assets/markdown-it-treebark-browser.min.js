...
`);return o+=`
`,o};function I(e,n={}){const o=e.data,r=n.logger||console,i=n.indent?{indentStr:typeof n.indent=="number"?" ".repeat(n.indent):typeof n.indent=="string"?n.indent:"  ",level:0,logger:r}:{logger:r};return $(e.template,o,i)}function Y(e,n,o,r,i,s,t,c=[]){const a=K(r,s),u=a.startsWith(`
`)&&s?s.repeat(t||0):"";if(e==="$comment")return`<!--${a}${u}-->`;const f=`<${e}${J(n,o,e,c,i)}>`;return b.has(e)?f:`${f}${a}${u}</${e}>`}function $(e,n,o){const r=o.parents||[],i=o.logger;if(typeof e=="string")return w(e,n,!0,r,i);if(Array.isArray(e))return e.map(l=>$(l,n,o)).join(o.indentStr?`
`:"");const s=M(e,i);if(!s)return"";const{tag:t,rest:c,children:a,attrs:u}=s;if(!W.has(t))return i.error(`Tag "${t}" is not allowed`),"";if(t==="$comment"&&o.insideComment)return i.error("Nested comments are not allowed"),"";if(t==="$if"){const{valueToRender:l}=F(c,n,r,i);return l===void 0?"":$(l,n,o)}b.has(t)&&a.length>0&&i.warn(`Tag "${t}" is a void element and cannot have children`);const f={...o,insideComment:t==="$comment"||o.insideComment,level:(o.level||0)+1},S=l=>l===""?[]:o.indentStr&&l.includes(`
`)&&!l.includes("<")?l.split(`
`).map(h=>[f.level,h]):[[f.level,l]];let d,p;if(q(c)){if(!v(c.$bind,"$bind",i))return"";const l=A(n,c.$bind,[],i),{$bind:h,$children:P=[],...L}=c;if(!Array.isArray(l)){if(l!=null&&typeof l!="object")return i.error(`$bind resolved to primitive value of type "${typeof l}", cannot render children`),"";const j=l&&typeof l=="object"&&l!==null?l:{},T=[...r,n];return $({[t]:{...L,$children:P}},j,{...o,parents:T})}if(d=[],!b.has(t))for(const j of l){const T=[...r,n];for(const Q of P){const X=$(Q,j,{...f,parents:T});d.push(...S(X))}}p=L}else{if(d=[],!b.has(t))for(const l of a){const h=$(l,n,{...f,parents:r});d.push(...S(h))}p=u}return Y(t,p,n,d,i,o.indentStr,o.level,r)}function J(e,n,o,r=[],i){const s=Object.entries(e).filter(([t])=>G(t,o,i)).map(([t,c])=>{let a;if(t==="style"){if(a=N(c,n,r,i),!a)return null}else if(z(c)){const u=B(c,n,r,i);a=w(String(u),n,!1,r,i)}else a=w(String(c),n,!1,r,i);return`${t}="${k(a)}"`}).filter(t=>t!==null).join(" ");return s?" "+s:""}function U(e,n={}){const{data:o={},yaml:r,indent:i,logger:s}=n,t=e.renderer.rules.fence;e.renderer.rules.fence=function(c,a,u,f,S){const d=c[a],p=d.info?d.info.trim():"";if(p==="treebark"||p.startsWith("treebark "))try{return H(d.content,o,r,i,s)+`
